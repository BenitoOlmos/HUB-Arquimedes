...
export default function App() {
  ...
  const gridFreqHz =
    gridAsset && breakers['TRAFO-01']
      ? scenarios.transmissionLineFault
        ? 47.8
        : 50.0 + Math.sin(Date.now() / 4000) * 0.04
      : 0;
    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100vh', overflow: 'hidden' }}>
      ...
      <header className="scada-header">
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
          ...
          >
            {soundEnabled ? (
              <Volume2 size={16} style={{ color: 'var(--hmi-cyan)' }} />
            ) : (
              <VolumeX size={16} />
            )}
      ...
      <div className="scada-workspace">
        ...
        <div className="scada-main-panel">
          <div style={{ flex: 1, display: 'flex', minHeight: 0 }}>
            ...
            {activeTab === 'gemelo' && <PlantViewer3D assets={assets} breakers={breakers} />}
          ...
          >
            <div
              className="hmi-card-title"
              style={{ color: 'var(--hmi-fault)', borderBottomColor: 'rgba(255, 0, 85, 0.2)' }}
            >
                    ...
                    alarms.map((alarm) => {
                      ...
                      return (
                        <tr key={alarm.id} className={rowClass}>
                          ...
                          <td>
                            <span
                              className={`status-pill ${alarm.severity === 'CRITICAL' ? 'fault' : 'maintenance'}`}
        ...
        <aside className="scada-console-panel">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
              <div className="instrument-gauge">
                ...
                <span
                  ...
                  style={{ color: gridPowerMW > 0 ? 'var(--hmi-cyan)' : 'var(--text-muted)' }}
                >
              ...
              <div className="instrument-gauge">
                ...
                <span
                  className="instrument-value"
                  style={{ color: gridFreqHz > 49.0 ? 'var(--hmi-online)' : 'var(--hmi-fault)' }}
                >
          ...
          <div className="hmi-card">
            ...
            <p style={{ fontSize: '11px', color: 'var(--text-muted)', marginBottom: '12px' }}>
              Modifica el pitch de los álabes para regular el coeficiente de potencia ($Cp$) y
              equilibrar la caída de generación.
            </p>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
              <div className="slider-group">
                ...
                >
                  ...
                  <span style={{ color: 'var(--hmi-cyan)', fontWeight: 'bold' }}>
                    {pitchAngles['WTG-01']}°
                  </span>
                </div>
                <input
          ...
          <div className="hmi-card">
            ...
            <p style={{ fontSize: '11px', color: 'var(--text-muted)', marginBottom: '12px' }}>
              Induce fallas o cortocircuitos eléctricos para evaluar las destrezas de diagnóstico y
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
              ...
              >
                {scenarios.transmissionLineFault
                  ? 'Eliminar Cortocircuito Red'
                  : 'Inducir Cortocircuito Línea'}
              </button>
              ...
              <button
                ...
                style={{ width: '100%', fontSize: '10px' }}
              >
                {scenarios.voltageSagActive
                  ? 'Estabilizar Tensión Red'
                  : 'Inducir Sag de Tensión (30%)'}
              </button>
            </div>
          </div>
        </aside>
      ...
      {ackModal && (
        ...
        >
          <div className="hmi-card" style={{ width: '360px', background: 'var(--hmi-panel)' }}>
            <div className="hmi-card-title">Clasificar Alarma (Norma ISA)</div>
            <p style={{ fontSize: '12px', color: 'var(--text-muted)', marginBottom: '16px' }}>
              Selecciona la prioridad y tipo de incidente para registrar el reconocimiento (ACK)
              formal del operador.
            </p>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
              <button
                className="hmi-button"
                onClick={() => handleAckAlarm(ackModal, 'Hardware')}
              ...
              <button
                className="hmi-button"
                onClick={() => handleAckAlarm(ackModal, 'Comunicación')}
                style={{ width: '100%', textAlign: 'left' }}
              >
              ...
              <button
                className="hmi-button"
                onClick={() => handleAckAlarm(ackModal, 'Seguridad')}
                style={{ width: '100%', textAlign: 'left' }}
              >
