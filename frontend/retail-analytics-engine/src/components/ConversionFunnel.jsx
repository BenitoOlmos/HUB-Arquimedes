      ...
      >
        ...
        <div className="glass-card" style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
          ...
          <div>
            ...
            <span style={{ fontSize: '0.75rem', color: '#fb7185', fontWeight: '500' }}>
              Carritos perdidos
            </span>
          </div>
        </div>
        ...
        <div className="glass-card" style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
          ...
          <div>
            <p style={{ color: 'var(--text-secondary)', fontSize: '0.85rem' }}>
              Pérdidas Quiebre Stock
            </p>
            <h3 style={{ fontSize: '1.75rem', margin: '0.25rem 0', color: '#f59e0b' }}>
              $
              {kpis.lostRevenue.toLocaleString('es-CL', {
        ...
        >
          <div>
            <h3 style={{ fontSize: '1.2rem', marginBottom: '0.25rem' }}>
              Embudo de Conversión de Sesiones
            </h3>
            <p style={{ color: 'var(--text-secondary)', fontSize: '0.85rem' }}>
