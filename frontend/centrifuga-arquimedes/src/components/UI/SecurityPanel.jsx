  ...
  useEffect(() => {
    const interval = setInterval(() => {
      ...
      if (failMode === 'normal') {
        ...
        setBearingTemp((prev) =>
          Math.max(82.0, Math.min(94.0, prev + (Math.random() - 0.5) * 1.5))
        );
    ...
    return (
      ...
      >
        {label && (
          ...
          >
            <span>{label}</span>
            <span style={{ color: pointerColor, fontFamily: 'monospace' }}>
              {currentVal.toFixed(1)}°C
            </span>
          </div>
        )}
  ...
  return (
    ...
    >
      ...
      <div style={{ borderBottom: '1px solid var(--border-glass)', paddingBottom: '20px' }}>
        ...
        >
          Seguridad Industrial y Telemetría IoT
        </h1>
        <p
          style={{
            fontSize: '1.05rem',
        ...
        >
          Visualización de protocolos de seguridad en Realidad Virtual e integración bidireccional
          de sensores para el monitoreo y mantenimiento de la maquinaria (Industria 4.0).
        </p>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px' }}>
        ...
        >
          ...
          >
            <ShieldCheck size={22} color="var(--status-operational)" /> Módulo de Ensayos Virtuales
            100% Seguros
          </h2>
          <p style={{ fontSize: '0.88rem', lineHeight: '1.5', color: 'var(--text-secondary)' }}>
            El simulador VR permite a los estudiantes realizar prácticas críticas de mantenimiento
            de alta peligrosidad eliminando por completo el riesgo de accidentes reales graves:
          </p>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
            ...
            >
              ...
              <div>
                ...
                >
                  Cero Riesgo de Electrocución
                </strong>
                <span style={{ fontSize: '0.8rem', color: 'var(--text-secondary)' }}>
                  Prácticas de desmontaje de caja de bornes y medición de bobinado del motor
                  eléctrico con tensión trifásica simulada sin riesgo de choque eléctrico.
                </span>
              </div>
            </div>
            <div
            ...
            >
              ...
              <div>
                ...
                >
                  Protocolo LOTO (Bloqueo y Etiquetado)
                </strong>
                <span style={{ fontSize: '0.8rem', color: 'var(--text-secondary)' }}>
                  El estudiante aprende la sequence obligatoria de bloqueo de disyuntores
                  mecánicos/eléctricos y colocación de candados de seguridad antes de manipular las
                  piezas.
                </span>
              </div>
            </div>
        ...
        >
          ...
          <p style={{ fontSize: '0.88rem', lineHeight: '1.5', color: 'var(--text-secondary)' }}>
            La plataforma interactúa de manera bidireccional. La telemetría captada por la maqueta o
            gemelo digital se transmite en tiempo real hacia los dashboards y el visor de realidad
            inmersiva (HUD):
          </p>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
            <div
            ...
            >
              <strong style={{ color: 'var(--accent-cyan)', width: '130px', flexShrink: 0 }}>
                Protocolos de Red:
              </strong>
              <span>
                WebSockets para actualización inmediata de gráficos, MQTT para sensores IoT
                industriales.
              </span>
            </div>
            <div
            ...
            >
              ...
              <span>
                Gafas de Realidad Virtual (HUD inmersivo) y Dashboard web unificado para docentes.
              </span>
            </div>
            <div
              style={{
            ...
            >
              ...
              <span>
                Alarma visual y sonora instantánea en caso de desbordamiento de límites térmicos o
                mecánicos.
              </span>
            </div>
          </div>
      ...
      >
        ...
        >
          <div>
            ...
            >
              <Activity size={20} color="var(--accent-cyan)" /> Telemetría de Control de Planta (IoT
              Simulado)
            </h2>
            <span style={{ fontSize: '0.78rem', color: 'var(--text-muted)', fontWeight: 600 }}>
              Inyecta fallas y observa el comportamiento de los sensores en tiempo real
            </span>
          </div>
          ...
          <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
            <button
              ...
              style={{
                ...
                padding: '6px 12px',
                borderRadius: '16px',
                background: failMode === 'normal' ? 'rgba(5, 185, 129, 0.08)' : '',
                borderColor: failMode === 'normal' ? 'var(--status-operational)' : '',
                color: failMode === 'normal' ? 'var(--status-operational)' : ''
              }}
            >
              Operación Normal
            </button>
            <button
              ...
              style={{
                ...
                padding: '6px 12px',
                borderRadius: '16px',
                background: failMode === 'cavitation' ? 'rgba(220, 38, 38, 0.08)' : '',
                borderColor: failMode === 'cavitation' ? 'var(--status-replace)' : '',
                color: failMode === 'cavitation' ? 'var(--status-replace)' : ''
              }}
            >
              Falla: Cavitación
            </button>
            <button
              ...
              style={{
                ...
                padding: '6px 12px',
                borderRadius: '16px',
                background: failMode === 'bearing' ? 'rgba(220, 38, 38, 0.08)' : '',
                borderColor: failMode === 'bearing' ? 'var(--status-replace)' : '',
                color: failMode === 'bearing' ? 'var(--status-replace)' : ''
              }}
            >
            ...
            <button
              ...
              style={{
                ...
                padding: '6px 12px',
                borderRadius: '16px',
                background: failMode === 'overheat' ? 'rgba(220, 38, 38, 0.08)' : '',
                borderColor: failMode === 'overheat' ? 'var(--status-replace)' : '',
                color: failMode === 'overheat' ? 'var(--status-replace)' : ''
              }}
            >
        ...
        {failMode !== 'normal' && (
          ...
          >
            ...
            >
              ...
              <strong style={{ fontSize: '0.92rem', textTransform: 'uppercase' }}>
                ALARMA CRÍTICA DE PLANTA:
              </strong>
            </div>
            <div style={{ fontWeight: '500', color: 'var(--text-secondary)', lineHeight: '1.4' }}>
              {failMode === 'cavitation' &&
                'Se detecta caída drástica de presión hidráulica e incremento destructivo de vibraciones en bomba (Posible obstrucción en succión).'}
              {failMode === 'bearing' &&
                'Temperatura límite superada en rodamiento radial de la bomba. Peligro de gripado del eje.'}
              {failMode === 'overheat' &&
                'Bobinados del estator registran temperatura crítica (>95°C). Alta corriente y peligro de daño del aislamiento.'}
            </div>
            ...
            {(failMode === 'bearing' || failMode === 'overheat') && (
              ...
              >
                {renderContextualTempChart(
                  bearingTemp,
                  'Contraste Térmico: Rodamientos de Bomba',
                  65,
                  80
                )}
                {renderContextualTempChart(
                  coilTemp,
                  'Contraste Térmico: Bobinas Estator Motor',
                  80,
                  95
                )}
              </div>
        ...
        >
          ...
          >
            ...
            <div>
              ...
              >
                <strong
                  style={{ fontSize: '1.6rem', color: getStatusColor(suctionPres, 0.8, 0.4) }}
                >
                  {suctionPres.toFixed(2)}
                </strong>
                <span
                  style={{
                    fontSize: '0.75rem',
          ...
          >
            ...
            <div>
              ...
              >
                <strong
                  style={{ fontSize: '1.6rem', color: getStatusColor(dischargePres, 3.5, 2.5) }}
                >
                  {dischargePres.toFixed(2)}
                </strong>
                <span
                  style={{
                    fontSize: '0.75rem',
          ...
          >
            ...
            <div>
              ...
              >
                <strong style={{ fontSize: '1.6rem', color: getStatusColor(bearingTemp, 70, 80) }}>
          ...
          >
            ...
            <div>
              ...
              >
                <strong style={{ fontSize: '1.6rem', color: getStatusColor(coilTemp, 85, 95) }}>
                  {coilTemp.toFixed(1)}
                </strong>
                <span
                  style={{
          ...
          >
            ...
            <div>
              ...
              >
                <strong style={{ fontSize: '1.6rem', color: getStatusColor(vibration, 3.0, 4.5) }}>
                  {vibration.toFixed(2)}
                </strong>
                <span
                  style={{
