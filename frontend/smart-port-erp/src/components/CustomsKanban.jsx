  ...
  const renderCard = (m) => {
    ...
    return (
      <div
        ...
        style={{
          borderLeft: hasDiscrepancy
            ? '3px solid var(--color-anchor)'
      ...
      >
        ...
        >
          <span
            style={{ fontSize: '0.65rem', color: 'var(--text-muted)', fontFamily: 'monospace' }}
          >
      ...
      <div className="glass-panel" style={{ display: 'flex', flexDirection: 'column' }}>
        <div className="panel-header">
          <div className="panel-title">
            <ClipboardCheck size={18} color="var(--color-approved)" /> Despacho de Cargas y Kanban
            de Aduana
          </div>
        ...
        <div className="kanban-board">
          ...
          <div className="kanban-column">
            ...
            <div className="kanban-cards-container">{pending.slice(0, 10).map(renderCard)}</div>
          </div>
          ...
          <div className="kanban-column">
            ...
            <div className="kanban-cards-container">{inspection.slice(0, 10).map(renderCard)}</div>
          </div>
          ...
          <div className="kanban-column">
            ...
            <div className="kanban-cards-container">{approved.slice(0, 10).map(renderCard)}</div>
          </div>
          ...
          <div className="kanban-column">
            ...
            <div className="kanban-cards-container">{held.slice(0, 10).map(renderCard)}</div>
          </div>
        </div>
      </div>
        ...
        {selectedManifest ? (
          (() => {
            ...
            return (
              ...
              >
                <div>
                  <strong style={{ display: 'block', color: 'var(--accent-cyan)' }}>
                    Manifiesto ID:
                  </strong>
                ...
                <div
                  style={{ borderBottom: '1px solid var(--border-glass)', paddingBottom: '0.5rem' }}
                >
                  <strong>Vía de Transporte:</strong> Maritime Cargo Carrier
                  <div style={{ fontSize: '0.72rem', color: 'var(--text-secondary)' }}>
                    IMO: {selectedManifest.shipId}
                  </div>
                </div>
                ...
                >
                  ...
                  <span className="incoterm-badge" style={{ fontSize: '0.85rem' }}>
                    {selectedManifest.incoterm}
                  </span>
                </div>
                  ...
                  >
                    ...
                    {weightMismatch && (
                      <div style={{ fontSize: '0.72rem' }}>
                        • **Diferencia de Peso**: El sensor de balanza física del puerto detectó
                        +50% de peso sobre lo declarado en el manifiesto.
                      </div>
                    )}
                    {wrongIncoterm && (
                      <div style={{ fontSize: '0.72rem' }}>
                        • **Incoterm Mismatch**: Se declaró Incoterm **EXW** para ruta marítima
                        principal, lo cual traslada la responsabilidad de flete de forma incorrecta.
                      </div>
                    )}
                  </div>
                )}
          ...
          >
            Selecciona un manifiesto de la lista Kanban para inspeccionar su Incoterm, discrepancia
            de peso y estado documental.
          </div>
        )}
      </div>
    </div>
