...
export default function CreditDashboard({ accounts }) {
  ...
  const portfolioStats = useMemo(() => {
    ...
    const averagePD =
      stressedPortfolio.reduce((acc, curr) => acc + curr.pd, 0) / (stressedPortfolio.length || 1);
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
        ...
        <div className="cyber-card cyan">
          ...
          <p style={{ fontSize: '13px', color: 'var(--text-muted)', marginBottom: '16px' }}>
            Ajusta la Tasa de Política Monetaria del Banco Central. Tipos de interés elevados
            encarecen el crédito incrementando la tasa de impago de la cartera.
          </p>

          <div className="slider-group">
            <div className="slider-labels">
              <span>Tasa Base (Bajo estrés)</span>
              <span style={{ color: 'var(--neon-cyan)', fontWeight: 'bold', fontSize: '15px' }}>
          ...
          >
            ...
            <div style={{ background: 'rgba(0,0,0,0.3)', padding: '12px', borderRadius: '6px' }}>
              ...
              <div
                ...
                style={{ color: 'var(--neon-magenta)', fontSize: '22px' }}
              >
