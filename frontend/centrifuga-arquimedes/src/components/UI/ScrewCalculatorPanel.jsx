...
const ScrewCalculatorPanel = () => {
  ...
  const boltGrades = {
    metric: [
      ...
      {
        grade: '8.8',
        label: 'Clase 8.8 (Alta Resistencia)',
        ultimateStress: 81.6,
        yieldStress: 65.3,
        material: 'Acero de medio carbono templado y revenido',
        markings: '8.8'
      },
      {
        grade: '10.9',
        label: 'Clase 10.9 (Extra Alta)',
        ultimateStress: 102.0,
        yieldStress: 91.8,
      ...
      {
        grade: '12.9',
        label: 'Clase 12.9 (Uso Estructural)',
        ultimateStress: 122.4,
        yieldStress: 110.1,
        material: 'Acero aleado templado y revenido de alta calidad',
        markings: '12.9'
      }
    ],
    inch: [
      ...
      {
        grade: 'G5',
        label: 'SAE Grado 5 (Intermedio)',
        ultimateStress: 84.4,
        yieldStress: 64.7,
        material: 'Acero de medio carbono templado y revenido',
        markings: '3 líneas radiales'
      },
      {
        grade: 'G8',
        label: 'SAE Grado 8 (Alta Resistencia)',
        ultimateStress: 105.5,
        yieldStress: 91.4,
        material: 'Acero aleado templado y revenido',
        markings: '6 líneas radiales'
      }
    ]
  };
  ...
  const activeGradeData = boltGrades[threadSystem].find((item) => item.grade === selectedGrade) || {
    ultimateStress: 81.6,
    yieldStress: 65.3,
    material: '',
    markings: ''
    ...
    >
      ...
      >
        <div>
          ...
          >
            Identificación y Cálculo de Roscas
          </h1>
          <p
            style={{
              fontSize: '1.05rem',
          ...
          >
            Módulo mecánico interactivo para el análisis dimensional de uniones atornilladas,
            inspección visual de marcas de resistencia e ingeniería de esfuerzos admisibles.
          </p>
        </div>
      </div>
      ...
      >
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            ...
            <div style={{ display: 'flex', gap: '10px' }}>
              <button
                ...
                style={{
                  ...
                  padding: '8px',
                  fontSize: '0.82rem',
                  background: threadSystem === 'metric' ? 'rgba(2, 132, 199, 0.08)' : '',
                  borderColor: threadSystem === 'metric' ? 'var(--accent-cyan)' : '',
                  color: threadSystem === 'metric' ? 'var(--accent-cyan)' : ''
                }}
              >
                Métrica (mm)
              </button>
              <button
                ...
                style={{
                  ...
                  padding: '8px',
                  fontSize: '0.82rem',
                  background: threadSystem === 'inch' ? 'rgba(2, 132, 199, 0.08)' : '',
                  borderColor: threadSystem === 'inch' ? 'var(--accent-cyan)' : '',
                  color: threadSystem === 'inch' ? 'var(--accent-cyan)' : ''
                }}
              >
                Whitworth (Pulgadas)
              </button>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
              <label
                style={{ fontSize: '0.78rem', fontWeight: '800', color: 'var(--text-secondary)' }}
              >
                Diámetro Nominal (𝜙)
              </label>
              <select
            ...
            >
              <div style={{ display: 'flex', flexDirection: 'column', gap: '2px' }}>
                <span
                  style={{ fontSize: '0.7rem', color: 'var(--text-muted)', fontWeight: 'bold' }}
                >
                  Paso de Rosca / Hilos
                </span>
          ...
          >
            ...
            >
              <div style={{ fontSize: '0.72rem', color: 'var(--text-muted)' }}>
                Resistencia Tracción ($S_t$):
                <br />
                <strong style={{ color: 'var(--accent-blue)', fontSize: '0.8rem' }}>
                  {activeGradeData.ultimateStress.toFixed(1)} kg/mm²
                </strong>
              </div>
              <div style={{ fontSize: '0.72rem', color: 'var(--text-muted)' }}>
                Límite Elástico ($S_y$):
                ...
                <strong style={{ color: 'var(--accent-indigo)', fontSize: '0.8rem' }}>
                  {activeGradeData.yieldStress.toFixed(1)} kg/mm²
                </strong>
              </div>
            </div>
          </div>
        ...
        >
          ...
          <div
            style={{
              background:
                'linear-gradient(135deg, rgba(2, 132, 199, 0.05) 0%, rgba(79, 70, 229, 0.05) 100%)',
          ...
          >
            ...
            <div>
              ...
              >
                <strong style={{ fontSize: '1.45rem', color: 'var(--text-primary)' }}>
                  {Math.round(RT).toLocaleString()} <span style={{ fontSize: '0.9rem' }}>kg</span>
                </strong>
                <span
                  style={{
                    fontSize: '0.88rem',
            ...
            <div>
              ...
              >
                <strong style={{ fontSize: '1.2rem', color: 'var(--text-secondary)' }}>
                  {Math.round(yieldLoad).toLocaleString()}{' '}
            ...
            >
              ...
              >
                <strong style={{ fontSize: '1.65rem', color: 'var(--status-operational)' }}>
                  {Math.round(safeLoad).toLocaleString()}{' '}
                  <span style={{ fontSize: '0.95rem' }}>kg</span>
                </strong>
                <span
                  style={{
                    fontSize: '1rem',
          ...
          >
            <strong>💡 Recomendación Técnica:</strong> La carga máxima de trabajo segura es de{' '}
            <strong>{Math.round(safeLoad).toLocaleString()} kg</strong>. Si el esfuerzo supera este
            umbral, se aconseja aumentar el diámetro del perno o emplear calidades superiores como
            10.9 o 12.9.
          </div>
        </div>
      </div>
          ...
          <table className="audit-table" style={{ width: '100%', fontSize: '0.78rem' }}>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td style={{ fontWeight: 'bold', color: 'var(--accent-indigo)' }}>
                  1000 MPa (102.0 kg/mm²)
                </td>
              ...
              <tr>
                ...
                <td style={{ fontWeight: 'bold', color: 'var(--status-replace)' }}>
                  1200 MPa (122.4 kg/mm²)
                </td>
