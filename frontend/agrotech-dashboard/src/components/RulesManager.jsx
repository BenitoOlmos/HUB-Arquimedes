...
const RulesManager = ({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      onTriggerAlert(
        `Regla Creada: "${ruleName}" para activar riego si humedad < ${threshold}% en ${zoneName}.`
      );
      setRuleName('');
    } catch (err) {
      console.error(err);
  ...
  return (
    <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: '1.5rem' }}>
      ...
      >
        ...
        >
          {rules.length === 0 ? (
            ...
            >
              No hay automatizaciones de riego guardadas. El aspersor solo responderá a control
              manual.
            </div>
          ) : (
            rules.map((rule, idx) => {
      ...
      >
        ...
        <div
          style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem', fontSize: '0.82rem' }}
        >
          <div
            style={{
          ...
          >
            ...
            <div style={{ fontSize: '0.65rem', color: 'var(--text-muted)', marginTop: '4px' }}>
              * Cada minuto de aspersores activos aumenta la huella hídrica y reduce la eficiencia
            ...
            >
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '2px' }}>
                ...
                <p style={{ fontSize: '0.68rem', lineHeight: '1.3' }}>
                  El suelo ha permanecido en niveles críticos de sequedad por demasiado tiempo. El
                  rendimiento proyectado de la cosecha se reduce. ¡Ajusta los umbrales de humedad de
                  las reglas!
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '2px' }}>
                <strong style={{ fontSize: '0.75rem' }}>
                  Desperdicio Excesivo de Recurso Hídrico
                </strong>
                <p style={{ fontSize: '0.68rem', lineHeight: '1.3' }}>
                  Has superado el presupuesto hídrico óptimo del predio. Tu calificación de
                  eficiencia hídrica decaerá en la evaluación. Optimiza la duración de los riegos.
                </p>
              </div>
            </div>
          )}
