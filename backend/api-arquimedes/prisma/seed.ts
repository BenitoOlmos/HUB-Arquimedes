...
const pumpParts = [
  {
    ...
    description:
      'Carcasa exterior que contiene el líquido y lo dirige a la boquilla de descarga. Su forma espiral actúa como difusor, convirtiendo la velocidad cinética en presión estática.',
    material: 'Fundición de Hierro (ASTM A48 Clase 30) o Acero Inoxidable Dúplex',
    function:
      'Alberga las piezas giratorias internas, contiene la presión del fluido y convierte la velocidad cinética en presión estática.',
    maintenanceInterval: 'Cada 24 meses',
    status: 'Operational',
    commonFailures:
      'Desgaste local por erosión de partículas abrasivas (arena), corrosión galvánica localizada, microfisuras por golpe de ariete.',
    technicianAlert:
      'Realizar medición de espesores por ultrasonido en la voluta. Ajustar pernos de brida en cruz para torque parejo.',
    ...
    installationNotes:
      'Montaje verificado. Anclaje de pernos de cimentación con torque de 120 N·m. Junta de grafito espiralada instalada.',
    ...
    maintenanceLogs: JSON.stringify([
      {
        ...
        date: '2025-01-10',
        tech: 'Héctor Gómez',
        desc: 'Inspección por líquidos penetrantes en junta. Reemplazo de junta elastomérica por grafito.'
      }
    ])
  },
  {
    ...
    description:
      'Componente giratorio principal equipado con álabes. Transfiere energía del motor al fluido, acelerándolo hacia afuera por fuerza centrífuga.',
    material: 'Bronce Alumínico (C95800) o Acero Inoxidable 316L',
    function:
      'Imparte velocidad al fluido que se bombea. Es el núcleo de transferencia de energía.',
    maintenanceInterval: 'Cada 12 meses',
    status: 'Operational',
    commonFailures:
      'Picaduras severas por cavitación, erosión abrasiva en filos de álabes, desbalance dinámico por incrustaciones.',
    technicianAlert:
      'Inspeccionar desgaste característico tipo panal de abejas. Balancear dinámicamente según norma ISO G2.5 antes de montar.',
    entryDate: '2024-01-15',
    operatingHours: 14820,
    ...
    lifecycleStage: 'Maintenance',
    installationNotes:
      'Balanceo dinámico ISO G2.5 aprobado. Ajuste de chaveta y tuerca del impulsor con arandela de seguridad.',
    ...
    maintenanceLogs: JSON.stringify([
      {
        ...
        date: '2025-01-12',
        tech: 'Carlos Mendoza',
        desc: 'Limpieza general y balanceo estático realizado. Suavizado de filos de álabes con amoladora.'
      }
    ])
  },
  {
    ...
    description:
      'Eje de acero rectificado de precisión que transmite el par de rotación del motor al impulsor. Debe resistir esfuerzos de flexión y torsión.',
    material: 'Acero de Alta Resistencia (AISI 4140) o SS 410',
    function:
      'Transmite el torque mecánico del motor al impulsor, manteniendo la alineación del rotor.',
    maintenanceInterval: 'Cada 18 meses',
    status: 'Operational',
    commonFailures:
      'Fatiga por torsión en chaveteros, deflexión por cargas hidráulicas desequilibradas, desgaste bajo la camisa.',
    technicianAlert:
      'Verificar excentricidad con reloj comparador (máx 0.05 mm). Inspeccionar chaveteros por partículas magnéticas.',
    entryDate: '2024-01-15',
    operatingHours: 14820,
    ...
    lifecycleStage: 'Maintenance',
    installationNotes:
      'Alineación láser de acoplamiento completada: desviación radial 0.02 mm, desviación axial 0.01 mm.',
    ...
    maintenanceLogs: JSON.stringify([
      {
        ...
        date: '2025-07-15',
        tech: 'Héctor Gómez',
        desc: 'Runout verificado en 0.02 mm, holgura dentro de la norma. Alineación láser con motor realizada.'
      }
    ])
  },
  {
    ...
    description:
      'Evita fugas del fluido bombeado entre el eje giratorio y la carcasa de la bomba. Utiliza caras de sellado de carbón y carburo de silicio.',
    material: 'Carburo de Silicio (SiC) vs Carbón, Juntas Tóricas de Viton',
    function:
      'Forma una barrera dinámica estanca alrededor del eje para evitar escapes de líquido presurizado.',
    maintenanceInterval: 'Cada 6 meses',
    status: 'Inspect',
    commonFailures:
      'Daño por choque térmico (marcha en seco), degradación de elastómeros, astillado de caras de fricción por sólidos.',
    technicianAlert:
      'Verificar caudal de la línea de lavado (Flush Plan 11). Jamás arrancar la bomba en seco para evitar quemar las caras del sello.',
    ...
    lifecycleStage: 'Maintenance',
    installationNotes:
      'Sello de cartucho instalado. Presión de flush verificada a 2.5 bar sobre presión de succión. Se verificó no arranque en seco.',
    ...
    maintenanceLogs: JSON.stringify([
      {
        ...
        date: '2025-07-15',
        tech: 'Carlos Mendoza',
        desc: 'Conversión de prensaestopas antiguo a sello mecánico de cartucho. Conexión de tubería de flush.'
      }
    ])
  },
  {
    ...
    description:
      'Soporta el conjunto del eje giratorio, absorbiendo las fuerzas de empuje hidráulico radiales y axiales. Mantiene la deflexión del eje dentro de tolerancias.',
    material: 'Acero de Rodamientos de Alto Carbono y Cromo (AISI 52100)',
    function:
      'Soporta las cargas radiales y de empuje axial del rotor, garantizando rotación libre con mínima fricción.',
    maintenanceInterval: 'Cada 6 meses',
    status: 'Operational',
    commonFailures:
      'Fatiga por picadura en pistas de rodadura, lubricación deficiente por exceso o falta de grasa, ingreso de agua al cuerpo de rodamientos.',
    technicianAlert:
      'Monitorear temperatura del cuerpo (máx 75°C). Analizar vibración en alta frecuencia (aceleración Gs) para detección temprana.',
    entryDate: '2024-01-15',
    operatingHours: 14820,
    ...
    lifecycleStage: 'Maintenance',
    installationNotes:
      'Rodamientos lubricados con grasa sintética Mobilith SHC 100. Holgura axial ajustada según catálogo del fabricante.',
    nextMaintenance: '2026-06-15',
    maintenanceLogs: JSON.stringify([
      {
        id: 'br-01',
        date: '2025-01-12',
        tech: 'Carlos Mendoza',
        desc: 'Lavado del cárter de aceite. Relleno con aceite sintético ISO VG 46 de alta viscosidad.'
      }
    ])
  },
  {
    ...
    description:
      'Cilindro de metal reemplazable colocado sobre el eje en la zona de sellado. Protege el eje de transmisión contra el desgaste, la corrosión y la erosión.',
    material: 'Acero Inoxidable Templado 420 o con recubrimiento de Stellite',
    function:
      'Protege el eje de transmisión principal del desgaste abrasivo y corrosivo bajo las caras del sello.',
    maintenanceInterval: 'Cada 12 meses',
    status: 'Replace',
    commonFailures:
      'Rayado profundo o ranuración por fricción, corrosión bajo tensión química, picaduras por entrada de sedimentos.',
    technicianAlert:
      'Inspeccionar rugosidad superficial (Ra máx 0.8 micrones). Reemplazar camisa si el surco excede 0.25 mm de profundidad.',
    entryDate: '2024-01-15',
    operatingHours: 14820,
    ...
    installationNotes:
      'Camisa montada con ajuste deslizante sobre el eje. O-rings internos lubricados con vaselina técnica.',
    ...
    maintenanceLogs: JSON.stringify([
      {
        ...
        date: '2025-01-12',
        tech: 'Héctor Gómez',
        desc: 'Superficie de la camisa pulida durante la revisión de rutina. Reinstalada con nuevas juntas tóricas.'
      }
    ])
  },
  {
    ...
    description:
      'Anillos reemplazables instalados en la carcasa e impulsor para proporcionar una holgura estrecha. Restringe la recirculación interna del fluido.',
    material: 'Bronce C93200 o Nitronic 60',
    function:
      'Reduce el caudal de recirculación interna desde la descarga a la succión para mantener la eficiencia de la bomba.',
    maintenanceInterval: 'Cada 18 meses',
    status: 'Operational',
    commonFailures:
      'Aferramiento por contacto metálico accidental, incremento de holgura por erosión de finos.',
    technicianAlert:
      'Medir holgura diametral en 4 puntos cardinales. Si la holgura duplica el diseño original, reemplazar los anillos.',
    entryDate: '2024-01-15',
    operatingHours: 14820,
    ...
    lifecycleStage: 'Maintenance',
    installationNotes:
      'Holgura diametral de diseño verificada en 0.28 mm. Fijación con pernos prisioneros y Loctite 243.',
    ...
    maintenanceLogs: JSON.stringify([
      {
        ...
        date: '2025-01-12',
        tech: 'Carlos Mendoza',
        desc: 'Medición de holgura de desgaste arrojó 0.38 mm (aceptable). Fijación de anillo de carcasa reajustada.'
      }
    ])
  },
  {
    ...
    description:
      'Puerto de entrada donde el fluido entra en la bomba. Diseñado para garantizar un flujo de entrada suave y de baja turbulencia.',
    ...
    status: 'Operational',
    commonFailures:
      'Estiramiento o corrosión de pernos de anclaje, fuga de la junta de brida por vibración del ducto.',
    technicianAlert:
      'Verificar tensión con torquímetro. Asegurar que las tuberías no transmitan cargas ni desalineación física sobre la brida.',
    entryDate: '2024-01-15',
    operatingHours: 14820,
    ...
    installationNotes:
      'Brida libre de tensiones externas. Tubería de succión soportada independientemente para evitar esfuerzos en carcasa.',
    ...
    maintenanceLogs: JSON.stringify([
      {
        ...
        date: '2025-01-10',
        tech: 'Héctor Gómez',
        desc: 'Reajuste de torque en tornillería de conexión. Reemplazo de junta por una espiralada de EPDM.'
      }
    ])
  },
  {
    ...
    description:
      'Motor asincrónico trifásico acoplado de inducción. Proporciona la potencia mecánica y el par necesario para accionar la bomba centrífuga a su velocidad nominal de diseño (2900 RPM).',
    material: 'Carcasa de Aluminio o Hierro Fundido con Bobinado de Cobre',
    function:
      'Convierte la energía eléctrica de entrada en energía rotacional mecánica para accionar el eje del impulsor.',
    maintenanceInterval: 'Cada 12 meses',
    status: 'Operational',
    commonFailures:
      'Cortocircuito en bobinado por humedad, sobrecalentamiento por sobrecarga eléctrica, falla de rodamientos del estator.',
    technicianAlert:
      'Medir resistencia de aislamiento (Megger) entre bobinados y carcasa. Inspeccionar temperatura en la carcasa con cámara termográfica.',
    entryDate: '2024-01-15',
    operatingHours: 14820,
    ...
    lifecycleStage: 'Maintenance',
    installationNotes:
      'Alineación láser de precisión realizada. Megger de bobinados arrojó > 100 Megaohms (Aprobado). Caja de conexiones estanca verificada.',
    ...
    maintenanceLogs: JSON.stringify([
      {
        ...
        date: '2025-01-12',
        tech: 'Carlos Mendoza',
        desc: 'Limpieza de aletas de refrigeración y engrase de rodamientos con grasa Mobil Polyrex EM.'
      }
    ])
  }
];
...
async function main() {
  ...
  const alertsData = flaggedTxs.map((tx, idx) => ({
    ...
    ruleTriggered:
      tx.amount === 9990
        ? 'MONTO_LIMITE_AML'
        : tx.ipAddress.startsWith('192.42')
          ? 'IP_DARKWEB_DETECTOR'
          : 'TRANSACCIONES_ALTA_VELOCIDAD',
  ...
  const assets = [
    {
      ...
      status: 'ONLINE',
      location: 'Zona Norte - Colina'
    },
    {
      tagId: 'WTG-02',
      assetType: 'WIND_TURBINE',
      status: 'ONLINE',
      location: 'Zona Norte - Cresta'
    },
    {
      tagId: 'PV-ARRAY-01',
      assetType: 'SOLAR_PANEL',
      status: 'ONLINE',
      location: 'Valle Sur - Bloque A'
    },
    {
      tagId: 'PV-ARRAY-02',
      assetType: 'SOLAR_PANEL',
      status: 'ONLINE',
      location: 'Valle Sur - Bloque B'
    },
    {
      tagId: 'INV-01',
      assetType: 'INVERTER',
      status: 'ONLINE',
      location: 'Subestación Inversores A'
    },
    {
      tagId: 'INV-02',
      assetType: 'INVERTER',
      status: 'ONLINE',
      location: 'Subestación Inversores B'
    },
    {
      tagId: 'TRAFO-01',
      assetType: 'TRANSFORMER',
      status: 'ONLINE',
      location: 'Punto de Inyección Grid'
    }
  ];
  ...
  for (const asset of createdAssets) {
    for (let h = 360; h >= 0; h--) {
      ...
      if (asset.assetType === 'SOLAR_PANEL') {
        ...
        const power =
          irradiance > 0 ? (irradiance * 8000 * 0.2 * (1 - 0.004 * (temp - 25))) / 1000 : 0;
        ...
        telemetryRecords.push({
          ...
          value: parseFloat(irradiance.toFixed(1)),
          timestamp
        });
        telemetryRecords.push({
          assetId: asset.id,
        ...
        telemetryRecords.push({
          assetId: asset.id,
          parameter: 'POWER',
          value: parseFloat((power / 1000).toFixed(3)),
          timestamp
        });
        telemetryRecords.push({
          assetId: asset.id,
        ...
        const solarPowerVal =
          hour >= 6 && hour <= 18 ? Math.sin(((hour - 6) / 12) * Math.PI) * 600 : 0;
        ...
        telemetryRecords.push({
          assetId: asset.id,
          parameter: 'POWER',
          value: parseFloat((powerOut / 1000).toFixed(3)),
          timestamp
        });
        ...
        if (asset.tagId === 'INV-02' && h === 0 && temp > 85) {
          alarmsRecords.push({
            ...
            description:
              'Temperatura crítica en inversor central - flujo de refrigeración insuficiente',
            severity: 'HIGH',
        ...
        telemetryRecords.push({
          assetId: asset.id,
          parameter: 'RPM',
          value: parseFloat(rpm.toFixed(1)),
          timestamp
        });
        telemetryRecords.push({
          assetId: asset.id,
        ...
        telemetryRecords.push({
          assetId: asset.id,
          parameter: 'POWER',
          value: parseFloat(totalPowerMW.toFixed(3)),
          timestamp
        });
        telemetryRecords.push({
          assetId: asset.id,
  ...
  const products = [
    {
      sku: 'SKU-SHOES-01',
      name: 'Zapatillas Trail Runner X',
      category: 'Calzado',
      basePrice: 89.9
    },
    { sku: 'SKU-SHOES-02', name: 'Zapatillas Urban Classic', category: 'Calzado', basePrice: 59.9 },
    {
      sku: 'SKU-JACKET-01',
      name: 'Chaqueta Cortavientos Outdoor',
      category: 'Vestuario',
      basePrice: 79.9
    },
    {
      sku: 'SKU-JACKET-02',
      name: 'Polerón Térmico Fleece',
      category: 'Vestuario',
      basePrice: 45.0
    },
    {
    ...
    { sku: 'SKU-CAP-02', name: 'Mochila Ergonómica 25L', category: 'Accesorios', basePrice: 39.9 },
    {
      sku: 'SKU-PANTS-01',
      name: 'Pantalón de Trekking Convert',
      category: 'Vestuario',
      basePrice: 49.9
    },
    {
      sku: 'SKU-PANTS-02',
      name: 'Calzas Deportivas Compresión',
      category: 'Vestuario',
      basePrice: 35.0
    }
  ];
  ...
  for (const store of stores) {
    for (const prod of createdProducts) {
      ...
      if (
        prod.sku === 'SKU-SHOES-01' &&
        (store.name.includes('Las Condes') || store.name.includes('Santiago Centro'))
      ) {
        stock = 0;
      }
  ...
  for (let i = 0; i < customers.length; i++) {
    ...
    for (let s = 0; s < numSessions; s++) {
      const sessionDate = new Date(
        retailSeedNow.getTime() - (s * 3 + i * 0.5) * 24 * 60 * 60 * 1000
      );
      ...
      if (isAddToCart) {
        ...
        const isAbandoned =
          isShoes01 && isTrapLocation ? Math.random() < 0.95 : Math.random() < 0.65;
  ...
  const intersections = [
    ...
    {
      name: 'Providencia / Pedro de Valdivia',
      lat: -33.424,
      lng: -70.612,
      greenPhase: 40,
      redPhase: 40,
  ...
  const machinesData = [
    ...
    {
      name: 'Soldadura Robótica (Estación 3)',
      type: 'ROBOTIC_ARM',
      sequenceOrder: 3,
      nominalCycleTime: 6.0
    },
    {
      name: 'Inspección de Calidad Óptica',
  ...
  for (let b = 0; b < batchesCount; b++) {
    const startTime = new Date(
      manufacturingSeedNow.getTime() - (batchesCount - b) * 8 * 60 * 60 * 1000
    ); // 8 hours per batch shift
  ...
  const reviewsData = [
    {
      ...
      comment: 'Habitación impecable y servicio de check-in rápido.',
      date: new Date(seedNow.getTime() - 2 * 24 * 3605 * 1000)
    },
    {
      score: 3,
      category: 'SERVICE',
      comment:
        'Overbooking! Me tuvieron esperando 2 horas en el lobby para reubicarme en otro hotel.',
      date: new Date(seedNow.getTime() - 4 * 24 * 3605 * 1000)
    },
    {
      score: 5,
      category: 'CLEANLINESS',
      comment: 'El baño tenía toallas usadas cuando entramos. Housekeeping demoró mucho.',
      date: new Date(seedNow.getTime() - 5 * 24 * 3605 * 1000)
    },
    {
      score: 8,
      category: 'VALUE_FOR_MONEY',
      comment:
        'Excelente suite con linda vista, aunque la tarifa dinámica es algo elevada los fines de semana.',
      date: new Date(seedNow.getTime() - 6 * 24 * 3605 * 1000)
    },
    {
      score: 10,
      category: 'SERVICE',
      comment: 'Personal muy amable. Resolvieron todas mis consultas al instante.',
      date: new Date(seedNow.getTime() - 1 * 24 * 3605 * 1000)
    }
  ];
  ...
  for (let i = -30; i <= 30; i++) {
    ...
    for (let b = 0; b < numBookings; b++) {
      const guestName =
        guests[Math.floor(Math.random() * guests.length)] + ' #' + Math.floor(Math.random() * 1000);
      ...
      reservations.push({
        guestName,
        roomId:
          status === 'CHECKED_IN' || (status === 'CONFIRMED' && Math.random() < 0.7)
            ? matchedRoom.id
            : null,
        bookingDate,
        checkInDate,
  ...
  const facilityData = [
    {
      name: 'Planta de Manufactura Santiago',
      country: 'CL',
      gridFactorId:
        dbFactors.find((f) => f.category === 'ELECTRICITY_CL' && f.validYear === 2025)?.id || ''
    },
    {
      name: 'Centro de Distribución Texas',
      country: 'US',
      gridFactorId:
        dbFactors.find((f) => f.category === 'ELECTRICITY_US' && f.validYear === 2025)?.id || ''
    },
    {
      name: 'Oficinas Centrales Londres',
      country: 'UK',
      gridFactorId:
        dbFactors.find((f) => f.category === 'ELECTRICITY_UK' && f.validYear === 2025)?.id || ''
    },
    {
      name: 'Planta de Ensamble Munich',
      country: 'DE',
      gridFactorId:
        dbFactors.find((f) => f.category === 'ELECTRICITY_DE' && f.validYear === 2025)?.id || ''
    }
  ];
  ...
  for (let m = 0; m < 12; m++) {
    ...
    for (const facility of dbFacilities) {
      for (const cat of categories) {
        ...
        const factor =
          dbFactors.find((f) => f.category === searchCategory && f.validYear === year) ||
          dbFactors[0];
  ...
  const marketData = [
    {
      projectName: 'Reforestación de Selva Amazónica',
    ...
    {
      projectName: 'Captura Directa de Aire (DAC) Climeworks',
      projectType: 'DAC',
    ...
    {
      projectName: 'Parque Eólico de la Patagonia',
    ...
    {
      projectName: 'Reforestación Comunitaria en Kenya',
      projectType: 'FORESTRY',
      certification: 'GOLD_STANDARD',
      pricePerTon: 22.0,
      availableTons: 15000
    ...
    {
      projectName: 'Captura de Biochar Agrícola',
      projectType: 'DAC',
      certification: 'VERRA',
      pricePerTon: 45.0,
      availableTons: 8000
    ...
    {
      projectName: 'Planta Solar Atacama',
      projectType: 'RENEWABLE',
      certification: 'GOLD_STANDARD',
      pricePerTon: 9.5,
      availableTons: 35000
  ...
  const hisDiagnosticsPool = [
    ...
    {
      text: 'Crisis hipertensiva sintomática',
      esi: 2,
      outcome: 'Alta',
      category: 'Cardiovascular'
    },
  ...
  hisSkuTemplates.forEach((template) => {
    ...
    const chosenVars =
      template.category === 'MEDICATION' ? variations.slice(0, 8) : variations.slice(6, 12);
  ...
  const hisBedsData = [
    ...
    ...Array(12)
      .fill(0)
      .map((_, i) => ({
        id: `MED-3${i + 1 < 10 ? '0' + (i + 1) : i + 1}`,
        ward: 'GENERAL',
        bedNumber: `MED-3${i + 1 < 10 ? '0' + (i + 1) : i + 1}`,
        status: 'AVAILABLE',
        currentPatient: null
      })),
    ...Array(8)
