  ...
  return (
    <div className="grid-cols-12">
      ...
      <div className="glass-card" style={{ gridColumn: 'span 7', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
        <div>
          <h3 style={{ fontSize: '1.2rem', marginBottom: '0.25rem' }}>Configuración de Intersecciones (Semáforos)</h3>
              ...
              >
                <div>
                  ...
                  <span style={{ fontSize: '0.75rem', color: 'var(--text-secondary)' }}>
                    Fase Verde: {inter.greenPhase}s | Roja: {inter.redPhase}s | Desfase: {inter.offset}s
                  </span>
                </div>
        ...
        <div style={{
          ...
          <div>
            <strong style={{ color: '#fff', display: 'block', marginBottom: '0.25rem' }}>Consejo de Optimización (Onda Verde):</strong>
            Para sincronizar los semáforos consecutivos en la Alameda (Las Rejas &rarr; Velásquez &rarr; Estación Central &rarr; Santa Lucía), los desfases (offsets) ideales deben configurarse de forma secuencial (ej. 0s, 5s, 10s, 15s) para permitir el flujo ininterrumpido a velocidad crucero.
          </div>
        </div>
      </div>
        ...
        {activeInter ? (
          <form onSubmit={handleSave} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
              <label style={{ fontSize: '0.85rem', color: 'var(--text-secondary)' }}>Fase Luz Verde (Segundos)</label>
              <input 
                type="number" 
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
              <label style={{ fontSize: '0.85rem', color: 'var(--text-secondary)' }}>Fase Luz Roja (Segundos)</label>
              <input 
                type="number" 
                className="form-input" 
                min="10" 
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
              <label style={{ fontSize: '0.85rem', color: 'var(--text-secondary)' }}>Desfase / Offset (Segundos)</label>
              <input 
                type="number" 
                className="form-input" 
                min="0" 
                ...
                required
              />
              <span style={{ fontSize: '0.7rem', color: 'var(--text-muted)' }}>Desfase de tiempo relativo al reloj patrón global.</span>
            </div>
