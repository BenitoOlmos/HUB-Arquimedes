...
export const mockVehicles = [
  ...
  ...Array.from({ length: 40 }, (_, i) => {
    ...
    const type =
      owner.includes('Flota') || owner.includes('Transportes') ? 'Empresa/Flota' : 'Particular';
    const year = 2015 + (i % 8);
...
const partsBase = [
  ...
  {
    name: 'Cazoleta amortiguador delantera',
    cat: 'Suspensión y Dirección',
    baseCost: 12000,
    min: 4,
    physical: 6
  ...
  {
    name: 'Kit bujes barra estabilizadora',
    cat: 'Suspensión y Dirección',
    baseCost: 5500,
    min: 10,
    physical: 14
  ...
  {
    name: 'Filtro de combustible diésel/bencina',
    cat: 'Motor y Filtros',
    baseCost: 8000,
    min: 8,
    physical: 10
  ...
  {
    name: 'Filtro de cabina/aire acondicionado',
    cat: 'Motor y Filtros',
    baseCost: 7000,
    min: 8,
    physical: 12
  ...
  {
    name: 'Aceite de motor 5W30 Sintético 4L',
    cat: 'Motor y Filtros',
    baseCost: 24000,
    min: 10,
    physical: 16
  ...
  {
    name: 'Bujía de encendido Iridium (unidad)',
    cat: 'Motor y Filtros',
    baseCost: 6000,
    min: 24,
    physical: 36
  ...
  {
    name: 'Correa de accesorios / alternador',
    cat: 'Motor y Filtros',
    baseCost: 11000,
    min: 5,
    physical: 8
  ...
  {
    name: 'Kit de distribución de motor',
    cat: 'Motor y Filtros',
    baseCost: 55000,
    min: 2,
    physical: 3
  ...
  {
    name: 'Empaquetadura culata de cilindros',
    cat: 'Motor y Filtros',
    baseCost: 18000,
    min: 3,
    physical: 5
  ...
  {
    name: 'Batería 12V 70AH libre mantención',
    cat: 'Eléctrico y Diagnóstico',
    baseCost: 45000,
    min: 5,
    physical: 8
  },
  ...
  {
    name: 'Motor de arranque de motor',
    cat: 'Eléctrico y Diagnóstico',
    baseCost: 72000,
    min: 2,
    physical: 3
  ...
  {
    name: 'Sensor de posición cigüeñal CKP',
    cat: 'Eléctrico y Diagnóstico',
    baseCost: 22000,
    min: 3,
    physical: 4
  ...
  {
    name: 'Fusible plano surtido (Kit 100u)',
    cat: 'Eléctrico y Diagnóstico',
    baseCost: 3500,
    min: 5,
    physical: 7
  ...
  {
    name: 'Computadora de motor ECU (Básica)',
    cat: 'Eléctrico y Diagnóstico',
    baseCost: 220000,
    min: 1,
    physical: 1
...
partsBase.forEach((p) => {
  carModelsSuffix.forEach((suffix) => {
    ...
    const costMultiplier = isUniversal
      ? 1.0
      : suffix.includes('Hilux')
        ? 1.4
        : suffix.includes('Accent')
          ? 0.95
          : 1.1;
...
export const mockSuppliers = [
  {
    ...
    reliability: 1.0, // 100%
    description:
      'Proveedor directo de fábrica. Repuestos 100% originales con garantía total y cero defectos, pero de costo elevado y envío lento.'
  },
  {
    id: 'SUP-QUAL',
    ...
    reliability: 0.95, // 95%
    description:
      'Excelente balance costo-beneficio. Plazo de entrega rápido de 24/48 horas y calidad certificada bajo normas ISO.'
  },
  {
    id: 'SUP-GEN',
    ...
    costMultiplier: 0.65,
    reliability: 0.8, // 80% (20% defect probability)
    description:
      'Distribuidor local de piezas genéricas. Entrega exprés en 2 horas, coste mínimo, pero propenso a piezas defectuosas.'
  }
];
...
export const mockMechanics = [
  {
    ...
    speed: 1.0,
    costPerDay: 45000,
    description: 'Velocidad estándar. Experto en suspensiones, motores y cajas mecánicas.'
  },
  {
    id: 'MEC-2',
    name: 'Carlos Mendoza',
    ...
    costPerDay: 55000,
    description:
      'Especialista en inyección electrónica, cableados, ECUs y sensores. Trabaja un 20% más rápido.'
  },
  {
    id: 'MEC-3',
    name: 'Jorge Oyarzún',
    ...
    speed: 1.1,
    costPerDay: 40000,
    description: 'Experto en afinamiento rápido, frenos y cambios de fluidos.'
  },
  {
    id: 'MEC-4',
    name: 'Marina Riquelme',
    specialty: 'Alineación y Suspensión',
    speed: 1.0,
    costPerDay: 48000,
    description: 'Especializada en geometrías de dirección, balanceo dinámico y amortiguación.'
  }
];
...
export const initialActiveOTs = [
  {
    ...
    partsRequired: [
      {
        sku: 'SKU-1008',
        name: 'Amortiguador delantero izquierdo (Toyota Hilux)',
        qty: 1,
        cost: 44800,
        price: 67200,
        status: 'Disponible'
      ...
      {
        sku: 'SKU-1013',
        name: 'Amortiguador delantero derecho (Toyota Hilux)',
        qty: 1,
        cost: 44800,
        price: 67200,
        status: 'Disponible'
  ...
  },
  {
    ...
    partsRequired: [
      {
        sku: 'SKU-1002',
        name: 'Pastillas de freno delanteras (Hyundai Accent)',
        qty: 1,
        cost: 11400,
        price: 17100,
        status: 'Pendiente'
      ...
      {
        sku: 'SKU-1022',
        name: 'Flexible de freno hidráulico (Hyundai Accent)',
        qty: 2,
        cost: 7600,
        price: 11400,
        status: 'Pendiente'
  ...
  },
  {
    ...
    partsRequired: [
      {
        sku: 'SKU-1129',
        name: 'Sensor de posición cigüeñal CKP (Nissan Versa)',
        qty: 1,
        cost: 24200,
        price: 36300,
        status: 'Pedido',
  ...
  },
  {
    ...
    partsRequired: [
      {
        sku: 'SKU-1079',
        name: 'Filtro de aceite sintético (Suzuki Swift)',
        qty: 1,
        cost: 5500,
        price: 8250,
        status: 'Disponible'
      ...
      {
        sku: 'SKU-1099',
        name: 'Aceite de motor 5W30 Sintético 4L (Suzuki Swift)',
        qty: 1,
        cost: 26400,
        price: 39600,
        status: 'Disponible'
      ...
      {
        sku: 'SKU-1104',
        name: 'Bujía de encendido Iridium (Suzuki Swift)',
        qty: 4,
        cost: 6600,
        price: 9900,
        status: 'Disponible'
  ...
  },
  {
    ...
    partsRequired: [
      {
        sku: 'SKU-1111',
        name: 'Kit de distribución de motor (Toyota Hilux)',
        qty: 1,
        cost: 77000,
        price: 115500,
        status: 'Disponible'
    ...
    dueDate: 'Día 1',
    notes:
      'Trabajo terminado. Vehículo lavado y estacionado en patio de entrega. Listo para facturación.',
    urgency: 'Alta'
  },
  {
    id: 'OT-2006',
    ...
    partsRequired: [
      {
        sku: 'SKU-1121',
        name: 'Alternador de carga 90A (Universal)',
        qty: 1,
        cost: 85000,
        price: 127500,
        status: 'Pendiente'
      ...
      {
        sku: 'SKU-1116',
        name: 'Batería 12V 70AH libre mantención (Universal)',
        qty: 1,
        cost: 45000,
        price: 67500,
        status: 'Pendiente'
  ...
  },
  {
    ...
    partsRequired: [
      {
        sku: 'SKU-1131',
        name: 'Computadora de motor ECU (Universal)',
        qty: 1,
        cost: 220000,
        price: 330000,
        status: 'Disponible'
  ...
  },
  {
    ...
    partsRequired: [
      {
        sku: 'SKU-1024',
        name: 'Amortiguador trasero (Universal)',
        qty: 2,
        cost: 28000,
        price: 42000,
        status: 'Pendiente'
      ...
      {
        sku: 'SKU-1049',
        name: 'Kit bujes barra estabilizadora (Universal)',
        qty: 1,
        cost: 5500,
        price: 8250,
        status: 'Pendiente'
  ...
  },
  {
    ...
    partsRequired: [
      {
        sku: 'SKU-1005',
        name: 'Discos de freno delanteros (Par) (Universal)',
        qty: 1,
        cost: 45000,
        price: 67500,
        status: 'Pedido',
  ...
  },
  {
    ...
    partsRequired: [
      {
        sku: 'SKU-1126',
        name: 'Fusible plano surtido (Kit 100u) (Universal)',
        qty: 1,
        cost: 3500,
        price: 5250,
        status: 'Pendiente'
  ...
  },
  {
    ...
    partsRequired: [
      {
        sku: 'SKU-1106',
        name: 'Correa de accesorios / alternador (Toyota Hilux)',
        qty: 1,
        cost: 15400,
        price: 23100,
        status: 'Pedido',
  ...
  },
  {
    ...
    partsRequired: [
      {
        sku: 'SKU-1118',
        name: 'Empaquetadura culata de cilindros (Universal)',
        qty: 1,
        cost: 18000,
        price: 27000,
        status: 'Disponible'
    ...
    dueDate: 'Día 2',
    notes:
      'Desmontaje de culata completado. Rectificado de superficie e instalación de empaquetadura nueva en progreso.',
    urgency: 'Alta'
  },
  {
    id: 'OT-2015',
    ...
    partsRequired: [
      ...
      {
        sku: 'SKU-1087',
        name: 'Aceite de motor 5W30 Sintético 4L (Universal)',
        qty: 2,
        cost: 24000,
        price: 36000,
        status: 'Pendiente'
